...
MHZ::MHZ(uint8_t rxpin, uint8_t txpin, uint8_t pwmpin, uint8_t type, uint16_t range) {
...
MHZ::MHZ(uint8_t pwmpin, uint8_t type, uint16_t range) {
  _pwmpin = pwmpin;
  _type = type;
  _range = range;
...
MHZ::MHZ(Stream * serial, uint8_t pwmpin, uint8_t type, uint16_t range) {
  _serial = serial;
  _pwmpin = pwmpin;
  _type = type;
  _range = range;
